    ...
    <div id="AboutUs" className="w-full h-auto bg-white" data-aos="fade-in">
      <div className="flex flex-col md:flex-row md:justify-between">
        ...
        <div className="hover:scale-105 hover:transition-all hover:duration-300 hover:ease-in-out">
          <button className="w-[115px] h-[41px] rounded-[5px] bg-[#7A983D] text-white lg:w-[141px] lg:h-[50px] hover:scale-105 hover:cursor-pointer lg:hover:cursor-pointer lg:hover:scale-105">
